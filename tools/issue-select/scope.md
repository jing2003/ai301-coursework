...
I am most comfortable with JavaScript/TypeScript, React, Next.js, HTML/CSS, and web application development, and I also have experience with Python, Java, SQL/PostgreSQL, Git/GitHub, APIs, and database-backed applications. I am interested in improving my software engineering, debugging, AI integration, and open-source contribution skills.

I prefer issues with a clear problem statement and a scope that can be understood and tested locally. I am comfortable learning unfamiliar parts of a codebase, but I would prefer to avoid issues that require deep expertise in highly specialized infrastructure, low-level systems programming, or technologies that would take substantial setup before I can reproduce the problem.
